    ...
    if (file) {
      ...
      reader.onload = (e) => {
        try {
          ...
          setError('Error processing file. Please make sure it is a valid keystroke log file.')
        } finally {
          setIsLoading(false)
        }
      }
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="Visualize your keyboard usage patterns" />
      ...
      <main className={styles.main}>
        ...
        {keystrokeData.length > 0 && (
          <>
            ...
            <div className={styles.chartContainer}>
              ...
              {activeTab === 'keyboard' && <KeyboardLayout data={keystrokeData} />}
            </div>
        ...
        <div className={styles.infoSection}>
          ...
          <p>
            This tool helps you visualize your keyboard usage patterns to optimize your custom keyboard layout.
            Upload your keystroke log file to see which keys you use most frequently and get suggestions for
